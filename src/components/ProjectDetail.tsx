				...
				<div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
					{isAssetsLoading ? (
						<div className="space-y-8 animate-pulse">
							<div className="rounded-[2rem] border border-white/10 bg-slate-950/82 p-8 shadow-[0_30px_80px_rgba(15,23,42,0.55)] backdrop-blur-2xl sm:p-10">
							...
							<div className="rounded-[2rem] border border-white/10 bg-slate-950/78 p-3 shadow-[0_30px_80px_rgba(15,23,42,0.45)] backdrop-blur-2xl">
												...
												{loopedImages.map(
													(image, index) => (
														<div
															...
															className="w-[clamp(22rem,72vw,96rem)] shrink-0 overflow-hidden rounded-2xl border border-white/10"
														>
															<img
																src={image}
																alt={`${project.title} screenshot ${index + 1}`}
																className="h-[clamp(18rem,42vh,48rem)] w-full object-cover"
															/>
														</div>
													),
												)}
